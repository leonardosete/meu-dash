...
def build_dashboard_context(
    ...
    """
    print("🏗️  Construindo contexto para o dashboard...")
    ...
    context = {
        ...
        'summary_filename': os.path.basename(os.path.join(output_dir, "resumo_geral.html")),
    ...
    print("✅ Contexto para o dashboard construído com sucesso.")
    return context
